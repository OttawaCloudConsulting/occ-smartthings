...
metadata {
	definition (name: "Aqara Humidity Sensor v3", namespace: "OttawaCloudConsulting", author: "bspranger") {
  ...
  capability 'Atmospheric Pressure Measurement'
    ...
    tiles(scale: 2) {
        ...
        // }
        valueTile("pressure", "device.atmosphericPressure", inactiveLabel: false, width: 2, height: 2) {
            state "pressure", label:'${currentValue}', icon:"https://raw.githubusercontent.com/bspranger/Xiaomi/master/images/XiaomiPressure.png",
            backgroundColors:[
                [value: 100, color: "#bc2323"],
                [value: 101, color: "#f1d801"],
                [value: 102, color: "#44b621"]
            ]
        }
