 ...
 */
 ...
 metadata {
	definition (name: "Xiaomi Aqara Wireless Switch", namespace: "OttawaCloudConsulting", author: "bspranger", minHubCoreVersion: "000.022.0002", ocfDeviceType: "x.com.st.d.remotecontroller") {
		capability "Battery"
		capability "Sensor"
		capability "Button"
