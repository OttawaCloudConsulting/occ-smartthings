...
metadata {
	definition (name: "Xiaomi Button", namespace: "OttawaCloudConsulting", author: "bspranger", minHubCoreVersion: "000.022.0002", ocfDeviceType: "x.com.st.d.remotecontroller") {
		capability "Actuator"
		capability "Battery"
		capability "Button"
