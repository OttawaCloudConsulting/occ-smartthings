 ...
 *
 *  Author: Paul Sheldon
 *  https://raw.githubusercontent.com/paulsheldon/SmartThings-PS/master/devicetypes/paulsheldon/aqara-cube-controller.src/aqara-cube-controller.groovy
 *
...
metadata {
	definition (name: "Aqara Cube Controller", namespace: "OttawaCloudConsulting", author: "Paul Sheldon") {
		capability "Actuator"
		capability "Button"
